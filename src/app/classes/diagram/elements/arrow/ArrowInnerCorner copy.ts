...
export class ArrowInnerCorner extends ArrowCorner {
    ...
    private createDragAndAddSvgs():SVGElement{
        ...
        if(this.cornerBefore != undefined){
            ...
            beforeDrag.onmousedown = e => this.diagram.onChildrenMouseDown(e,this.cornerBefore!, this.diagram.DRAG_THIS_CORNER_AND_ITS_AFTER_CORNER)
        ...
        if(this.cornerAfter != undefined){
            ...
            afterDrag.onmousedown = e => this.diagram.onChildrenMouseDown(e,this, this.diagram.DRAG_THIS_CORNER_AND_ITS_AFTER_CORNER)
